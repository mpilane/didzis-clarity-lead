      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start mb-16">
          ...
          <div className="lg:w-2/3 space-y-6">
            ...
            <p className="text-lg text-consultant-gray-800 mb-6 text-justify">With over 20 years of experience in business leadership and operational management, I’ve led transformation, process optimization, and team development across diverse industries - from manufacturing and food production to apparel and construction. I specialize in turning complexity into clarity.
        ...
        <div className="flex justify-center">
          <div className="max-w-4xl w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {keyStrengths.map((strength, index) => <div key={index} className="pb-6 border-b border-gray-200">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button onClick={() => toggleStrength(index)} className="text-consultant-navy hover:text-consultant-navy/70 transition-colors ml-3 mt-1">
                      {expandedStrengths.includes(index) ? <ChevronUp className="h-5 w-5" /> : <ChevronDown className="h-5 w-5" />}
                    </button>
                  </div>
                  {expandedStrengths.includes(index) && <div className="space-y-2 text-consultant-gray-700 mt-4">
