...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-consultant-navy text-white">
      <div className="container mx-auto px-4">
        <h2 className="section-heading text-center mb-16 uppercase">MEET DIDZIS PIĻĀNS</h2>

        <div className="flex flex-col md:flex-row gap-8 items-stretch">
          <div className="md:w-1/3">
            <p className="text-xl font-medium text-consultant-blue-300 mb-4">
              Business transformation expert. Team leader. Change maker.
            </p>
            
            <div className="mb-6 p-4 bg-consultant-navy-800 rounded-lg border-l-4 border-consultant-blue-500 h-full">
          ...
          <div className="md:w-2/3">
            <p className="text-lg text-white mb-6">
              With more than two decades of leadership experience across Europe and industries like manufacturing, construction, food, and apparel, I specialize in turning complexity into clarity. I've led strategic change in large companies — including restoring profitability at Spectre Latvia through a 20% efficiency gain — and helped fast-growing startups structure their success.
            </p>
            <p className="text-lg text-white mb-6">
