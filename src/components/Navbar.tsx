  ...
  return (
    <nav className="fixed w-full bg-white/90 backdrop-blur-sm shadow-sm z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <a href="#" className="text-consultant-navy font-heading font-bold text-xl">
          Didzis Piļāns
        </a>
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden text-consultant-navy p-2"
        >
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-md p-4 flex flex-col space-y-4">
            <a
              href="#about"
              className="text-consultant-gray-700 hover:text-consultant-blue-600 p-2"
              onClick={toggleMenu}
            >
              About
            </a>
