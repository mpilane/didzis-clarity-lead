...
const ApproachSection = () => {
  ...
  return <section id="approach" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="section-heading text-center mb-16 uppercase">MY 4-STEP APPROACH</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => <div key={step.number} className="flex flex-col items-center bg-consultant-blue-50 rounded-lg shadow-md p-8 hover:shadow-lg transition-all duration-300 border-t-4 border-consultant-blue-500">
              <div className="flex items-center justify-center w-20 h-20 rounded-full bg-consultant-navy mb-6">
                {step.icon}
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-consultant-blue-300 mb-2">{step.number}</div>
